    ...
    <>
      <div className="w-[90%] flex gap-3.5  justify-between items-center  h-screen  ">
        <section className="flex flex-col   gap-8 items-baseline justify-center text-left  min-h-screen px-4 ">
          <h1 className="text-5xl boldonse-regular text-pop-up-right  ">
            <span className="text-purple-500  ">I'm </span>{" "}
            <span className=" px-3  text-white/80 ">Jeya Sudhan,</span>
          </h1>

          <p className="text-md capitalize poppins-medium   text-white/60 opacity-90 max-w-xl text-pop-up-right-delay2">
          ...
          <div className="flex gap-6 text-pop-up-right-delay3  ">
            <button className="relative bg-[#3b234b] text-white poppins-medium px-7 rounded-2xl">
              Hire Me
              <span
                className="absolute right-2 top-5 -translate-y-1/4 
                Blinking"
              >
                <FaArrowPointer />
              </span>
        ...
        <section className="       z-10  relative flex items-center justify-center ">
